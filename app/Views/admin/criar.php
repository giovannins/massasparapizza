...
<div class="container mt-5">
    <div id="produtos" class="row">
        ...
        <div class="text-center">
                <h5 class="display-5">Criar produto</h5>
            </div>
            <div class="card m-2">
                <div class="card-body">
                    <form action="/admin/api/store" method="post" autocomplete="off">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                        ...
                        <div class="text-end">
                            <button class="btn btn-success"><i class="bi bi-plus-lg"></i> Criar produto</button>
                        </div>
                    </form>
                </div>
            </div>
